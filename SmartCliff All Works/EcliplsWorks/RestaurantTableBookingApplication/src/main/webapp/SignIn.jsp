...
<div>
     <a class="btn btn-sm" style="align-items:right; background-color:black; color:#FDD023;" href="SignIn.jsp">Sign In</a>
				...
				<form action="cuslogin" onsubmit="return validate()" method="post">
					...
					<div class="container">
						...
						<div class="split left">
							<label for="password_signin">Password <label Style="color:red;">*</label></label><br> 
							<input
								class="inputfield" type="password" id="password_signin"
						...
						<br>
      						...
      						if(err!=null){ %>
      						<div class="container">
           						 <div id="time" style="color:red;margin-left: 10%; font-weight: 700;"><%=err %></div>
           						 </div>
          							<% }
      								session.setAttribute("err",null);%>
...
$("#time").fadeTo(2000, 500).slideUp(500, function(){
