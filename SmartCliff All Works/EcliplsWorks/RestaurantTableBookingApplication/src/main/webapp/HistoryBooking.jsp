...
<div class="w3-top">
 <div class="w3-bar w3-theme-d2 w3-left-align">
  ...
  <a href="HistoryBooking.jsp?id=<%=cus.getCustomerId()%>" class="w3-bar-item w3-button w3-hide-small w3-hover-white"  style="background-color:#F7CA3E;color:black; border-radius:50px;">History</a>
